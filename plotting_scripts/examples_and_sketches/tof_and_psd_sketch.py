...
# dummy=D.query('0<ps<0.3 and 0<E<5').head(10000)
# plt.figure(figsize=(6.2,2.1))
# plt.subplot(1,2,1)
# plt.scatter(dummy.E, 1-(dummy.qdc_sg/ (dummy.qdc_lg+200000)), color='black', alpha=0.05, s=10)
# plt.box(on=None)
# plt.xticks([], [])
# plt.yticks([], [])
...
# plt.ylabel('PS')
# plt.subplot(1,2,2)
# plt.scatter(dummy.E, dummy.ps, color='black', alpha=0.05, s=10)
# plt.box(on=None)
# plt.xticks([], [])
# plt.yticks([], [])
# plt.xlabel('$\mathrm{Q_{lg}}$')
